...
import net.swordie.ms.handlers.TraceKingHandler;
...
public class ScriptManagerImpl implements ScriptManager {
    ...
    public void startScript(int parentID, int objID, String scriptName, ScriptType scriptType) {
        ...
        // 获取到tradeking信息就加入
        if (chr != null) {
            TraceKingUserInfo tradeKingInfo = TraceKingHandler.getTradeKingInfo(chr);
            if (tradeKingInfo != null) {
...
//            return "server restarting soon";
    ...
    public void clickTradeKingNPC(int npcId) {
        // 发两个message
        // 再发返回
        TraceKingHandler.clickTradeKingNPC(chr, npcId);
    }
