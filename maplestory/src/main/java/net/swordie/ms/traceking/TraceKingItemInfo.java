...
public class TraceKingItemInfo {
    ...
    public TraceKingItemInfo(int id, int buyPrices, int sellPrices, int qr, int qrEx) {
        this.id = id;
    ...
    public TraceKingItemInfo(int id, String itemName, int buyPrices, int sellPrices, int qr, int qrEx) {
        this.id = id;
