...
//    unuse
    ...
    Res_Couple_Done(72),
    Res_Couple_Failed(73),

    Res_Friendship_Done(74),
    Res_Friendship_Failed(75),

    RS_UNKNOW_76(76),
    RS_UNKNOW_77(77),

    Res_BuyPackage_Done(78),
    Res_BuyPackage_Failed(79),

    Res_GiftPackage_Done(80),
    Res_GiftPackage_Failed(81),

    Res_BuyNormal_Done(82),
    Res_BuyNormal_Failed(83),
...
//    Res_Bridge_Failed(97),
    ...
    Res_PurchaseRecord_Done(107),
    Res_PurchaseRecord_Failed(108),


    Res_DeletePurchaseRecord_Done(109),
    Res_DeletePurchaseRecord_Failed(110),
...
//    Res_Refund_Failed(104),
    ...
    Res_UseRandomCashItem_Done(111),
    Res_UseRandomCashItem_Failed(112),
...
//    Res_SetAndroidName_Failed(108),
    ...
    Res_UseMaplePointGiftToken_Done(115),
    Res_UseMaplePointGiftToken_Failed(116),
    Res_BuyByToken_Done(117),
    Res_BuyByToken_Failed(118),
    Res_UpgradeValuePack_Done(119),
    Res_UpgradeValuePack_Failed(120),
    Res_EventCashItem_Buy_Result(121),
    Res_BuyFarmGift_Done(122),
    Res_BuyFarmGift_Failed(123),
...
//    Res_DestroyFriendShipRings_Failed(129),
    ...
    Res_LockerTransfer_Done(134),
    Res_LockerTransfer_Failed(135),
